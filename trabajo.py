...
def menu():
    ...
    while opcion != "0":  # Salir solo si la opción es 0
        ...
        if opcion == "0":
            ...
            try:
                with open("carga_de_informacion/productos.json", "r", encoding="utf-8") as archivo:
            ...
            if sub_opcion == 1:
                ...
                with open("carga_de_informacion/productos.json", "w", encoding="utf-8") as archivo:
            ...
            try:
                with open("carga_de_informacion/clientes.txt", "r", encoding="UTF-8") as file:
                    ...
                    if linea == "":
                        ...
                        print(f"{'ID':<10}{'Nombre':<20}{'Telefono':<10}")
                    while linea:
                        idcliente, nombre, telefono = linea.strip().split(";")
                        print(f"{idcliente:<10}{nombre:<20}{telefono:<10}")
                        linea = file.readline()
            except OSError:
            ...
            if sub_opcion == 1:
                ventas = cargar_ventas("carga_de_informacion/ventas.txt", "carga_de_informacion/productos.json", "carga_de_informacion/clientes.txt")
            elif sub_opcion == 2:
